...
dwv.gui.getWindowSize = function () {
	...
	return { 'width': ($(window).width() - $(window).width()/7 ) / 2 , 'height': $(window).height() - 147 };
};
// Prompt
...
dwv.gui.Toolbox = function (app)
{
    ...
    this.setup = function (list)
    {
        ...
        /*if(flag_lzl == 0){ //测试成功
        	dicomList = ["http://localhost:8080/test/xd/test_lzl/datatest2/111_00001_.dcm","http://localhost:8080/test/xd/test_lzl/datatest2/111_00002_.dcm",
            	"http://localhost:8080/test/xd/test_lzl/datatest2/111_00003_.dcm","http://localhost:8080/test/xd/test_lzl/datatest2/111_00004_.dcm"];
        	flag_lzl++;
        }*/
        var dcms2 = ["http://localhost:8080/test/xd/test_lzl/datatest2/111_00001_.dcm","http://localhost:8080/test/xd/test_lzl/datatest2/111_00002_.dcm",
        	"http://localhost:8080/test/xd/test_lzl/datatest2/111_00003_.dcm","http://localhost:8080/test/xd/test_lzl/datatest2/111_00004_.dcm","http://localhost:8080/test/xd/test_lzl/datatest2/111_00005_.dcm"];
        var loadUrls = document.createElement("a");
        var loadUrlsText= document.createTextNode("加载dcm");
        loadUrls.appendChild(loadUrlsText);
        loadUrls.setAttribute("class", buttonClass + " download-state ui-icon-action");
