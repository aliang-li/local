...
public class UserService {
	 ...
	 * @throws UserException 
	 */
	public void updateDate(String date,String uid) throws UserException {

		try {
			userDao.updateDate(date,uid);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
	 ...
	 */
	public User login(User user) throws ParseException {
		try {
	...
	*/
	 ...
	 * @return
	 */
	public boolean ajaxValidateIphone(String iphone) {
		try {
			return userDao.ajaxValidateIphone(iphone);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
