...
public class UserServlet extends BaseServlet {
	...
	String DiagnosePath="/home/wangning/diagnose/";
	// ajax用户名是否注册校验
	...
	public String regist(HttpServletRequest req, HttpServletResponse resp)
		...
		File DiagnoseHospitalDir=new File(DiagnosePath+asdHospital);
		if (!DiagnoseHospitalDir.exists()) {                           
			DiagnoseHospitalDir.mkdir();     
		     }			 
		...
		File DiagnoseHospitalDir1=new File(DiagnosePath+asdHospital+"/maindirforemptydirexceptopn_neverwillbeRegisted");
		 if (!DiagnoseHospitalDir1.exists()) {                           
			 DiagnoseHospitalDir1.mkdir();     
		 }
		 ...
		 */
				...
				if(user == null) {
					...
					return "r:/jsps/user/login.jsp";
						...
						String returnUrl="http://localhost:8080/BB/jsps/test.jsp?param0=000&param1=000&param2=000&param3=000&param4=000&param5=000";
